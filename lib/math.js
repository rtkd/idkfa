...
const Integer   = require('./integers.js');
...
const Evaluate = (() =>
{
    ...
    MathJS.import(
    {
        ...
        '$'         : integrate,
        'ephi'      : NT.eulerPhi,
        'fib'       : Fibonacci.getFibonacci,
        'int'       : Integer.getAll,
        'odd'       : Integer.getOdd,
        'even'      : Integer.getEven,
        'mob'       : NT.mobius,
        'prime'     : Primes.getPrimes
    ...
    {
        // ?
        Fibonacci.setLimit(intKeyLength);
        Integer.setLimit(intKeyLength);
